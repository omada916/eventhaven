 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mw(i,e){return Xn(i,"POST","/v1/accounts:delete",e)}async function qm(i,e){return Xn(i,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function el(i,e,n){return`firebase:${i}:${e}:${n}`}class Jr{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:l,name:u}=this.auth;this.fullUserKey=el(this.userKey,l.apiKey,u),this.fullPersistenceKey=el("persistence",l.apiKey,u),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?an._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new Jr(un(Pp),e,s);const l=(await Promise.all(n.map(async g=>{if(await g._isAvailable())return g}))).filter(g=>g);let u=l[0]||un(Pp);const d=el(s,e.config.apiKey,e.name);let f=null;for(const g of n)try{const y=await g._get(d);if(y){const E=an._fromJSON(e,y);g!==u&&(f=E),u=g;break}}catch{}const p=l.filter(g=>g._shouldAllowMigration);return!u._shouldAllowMigration||!p.length?new Jr(u,e,s):(u=p[0],f&&await u._set(d,f.toJSON()),await Promise.all(n.map(async g=>{if(g!==u)try{await g._remove(d)}catch{}})),new Jr(u,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kw(i,e={}){return Xn(i,"GET","/v2/passwordPolicy",Er(i,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oc{constructor(e,n){this.providerId=e,this.signInMethod=n}toJSON(){return ln("not implemented")}_getIdTokenResponse(e){return ln("not implemented")}_linkToIdToken(e,n){return ln("not implemented")}_getReauthenticationResolver(e){return ln("not implemented")}}async function cE(i,e){return Xn(i,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eS(i,e={}){return Xn(i,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vu="webStorageSupport";class kS{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=mg,this._completeRedirectFn=QE,this._overrideRedirectResult=KE}async _openPopup(e,n,s,l){var u;fn((u=this.eventManagers[e._key()])===null||u===void 0?void 0:u.manager,"_initialize() not called before _openPopup()");const d=await Wp(e,n,s,nc(),l);return wS(e,d,Lc())}async _openRedirect(e,n,s,l){await this._originValidation(e);const u=await Wp(e,n,s,nc(),l);return PE(u),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:l,promise:u}=this.eventManagers[n];return l?Promise.resolve(l):(fn(u,"If manager is not set, promise should be"),u)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await pS(e),s=new JE(e);return n.register("authEvent",l=>(Y(l==null?void 0:l.authEvent,e,"invalid-auth-event"),{status:s.onEvent(l.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(Vu,{type:Vu},l=>{var u;const d=(u=l==null?void 0:l[0])===null||u===void 0?void 0:u[Vu];d!==void 0&&n(!!d),zt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=rS(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return ig()||Jm()||Ac()}}const NS=kS;var Vp="@firebase/auth",Bp="1.8.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AS=5*60,OS=Om("authIdTokenMaxAge")||AS;let Hp=null;const DS=i=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>OS)return;const l=n==null?void 0:n.token;Hp!==l&&(Hp=l,await fetch(i,{method:l?"POST":"DELETE",headers:l?{Authorization:`Bearer ${l}`}:{}}))};function LS(i=jm()){const e=Tc(i,"auth");if(e.isInitialized())return e.getImmediate();const n=sE(i,{popupRedirectResolver:NS,persistence:[UE,kE,mg]}),s=Om("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const d=DS(u.toString());CE(n,d,()=>d(n.currentUser)),SE(n,f=>d(f))}}const l=xm("auth");return l&&lE(n,`http://${l}`),n}function MS(){var i,e;return(e=(i=document.getElementsByTagName("head"))===null||i===void 0?void 0:i[0])!==null&&e!==void 0?e:document}Xw({loadJS(i){return new Promise((e,n)=>{const s=document.createElement("script");s.setAttribute("src",i),s.onload=e,s.onerror=l=>{const u=Yt("internal-error");u.customData=l,n(u)},s.type="text/javascript",s.charset="UTF-8",MS().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});xS("Browser");/*! js-cookie v3.0.5 | MIT */function Qo(i){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var s in n)i[s]=n[s]}return i}var bS={read:function(i){return i[0]==='"'&&(i=i.slice(1,-1)),i.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)},write:function(i){return encodeURIComponent(i).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent)}};function sc(i,e){function n(l,u,d){if(!(typeof document>"u")){d=Qo({},e,d),typeof d.expires=="number"&&(d.expires=new Date(Date.now()+d.expires*864e5)),d.expires&&(d.expires=d.expires.toUTCString()),l=encodeURIComponent(l).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape);var f="";for(var p in d)d[p]&&(f+="; "+p,d[p]!==!0&&(f+="="+d[p].split(";")[0]));return document.cookie=l+"="+i.write(u,l)+f}}function s(l){if(!(typeof document>"u"||arguments.length&&!l)){for(var u=document.cookie?document.cookie.split("; "):[],d={},f=0;f<u.length;f++){var p=u[f].split("="),g=p.slice(1).join("=");try{var y=decodeURIComponent(p[0]);if(d[y]=i.read(g,y),l===y)break}catch{}}return l?d[l]:d}}return Object.create({set:n,get:s,remove:function(l,u){n(l,"",Qo({},u,{expires:-1}))},withAttributes:function(l){return sc(this.converter,Qo({},this.attributes,l))},withConverter:function(l){return sc(Qo({},this.converter,l),this.attributes)}},{attributes:{value:Object.freeze(e)},converter:{value:Object.freeze(i)}})}var FS=sc(bS,{path:"/"});const US=(i,e,n)=>{FS.set(i,e,{expires:n}),console.log("Cookie set!")},oc=async(i,e,n)=>{try{return await(await fetch(i,{method:e,body:n,headers:{"Content-type":"application/JSON; charset=UTF-8"}})).json()}catch(s){console.error(`Error: ${s.message}`)}},jS={apiKey:"AIzaSyDol293-uzm6oykcG47e_M4aOj71zG4U9U",authDomain:"node-project-a176d.firebaseapp.com",projectId:"node-project-a176d",storageBucket:"node-project-a176d.firebasestorage.app",messagingSenderId:"705351216802",appId:"1:705351216802:web:d16ccfa16d0f9d1da9b1fb",measurementId:"G-0L9BLHYXST"},zS=kc(jS),WS=LS(zS);async function VS(i){const e=await bw(i);US("token",e,30)}const BS=async(i,e)=>{try{const s=(await EE(WS,i,e)).user;console.log("signin complete"),await VS(s)}catch(n){console.error(`Error: ${n.message}`)}},HS=async(i,e,n,s)=>{await oc("/auth/signup","POST",JSON.stringify({name:i,username:e,email:n,password:s}))},$S=({setCurrentPage:i})=>{const[e,n]=vt.useState(""),[s,l]=vt.useState(""),[u,d]=vt.useState(""),[f,p]=vt.useState(""),g=y=>{y.preventDefault(),HS(e,f,s,u),console.log(`Registered user ${f}`)};return O.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gray-100",children:O.jsxs("form",{onSubmit:g,className:"bg-white p-8 rounded-lg shadow-md w-full max-w-md",children:[O.jsx("h1",{className:"text-2xl font-bold mb-6 text-center",children:"Register"}),O.jsxs("div",{className:"mb-4",children:[O.jsx("label",{className:"block text-gray-700",children:"Name"}),O.jsx("input",{type:"text",placeholder:"Name",value:e,onChange:y=>n(y.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsxs("div",{className:"mb-4",children:[O.jsx("label",{className:"block text-gray-700",children:"Username"}),O.jsx("input",{type:"text",placeholder:"Username",value:f,onChange:y=>p(y.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsxs("div",{className:"mb-4",children:[O.jsx("label",{className:"block text-gray-700",children:"Email"}),O.jsx("input",{type:"email",placeholder:"Email",value:s,onChange:y=>l(y.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsxs("div",{className:"mb-6",children:[O.jsx("label",{className:"block text-gray-700",children:"Password"}),O.jsx("input",{type:"password",placeholder:"Password",value:u,onChange:y=>d(y.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsx("button",{type:"submit",className:"w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition duration-300",children:"Register"}),O.jsxs("p",{children:["Have an account?"," ",O.jsx("a",{onClick:()=>{i("login")},className:"text-blue-200 font-bold cursor-pointer",children:"Log In"})]})]})})},GS=({setCurrentPage:i})=>{const[e,n]=vt.useState(""),[s,l]=vt.useState(""),u=d=>{d.preventDefault(),console.log(`User: ${e}, Pw: ${s}`),BS(e,s)};return O.jsx("div",{className:"min-h-screen flex items-center justify-center bg-gray-100",children:O.jsxs("form",{onSubmit:u,className:"bg-white p-8 rounded-lg shadow-md w-full max-w-md",children:[O.jsx("h1",{className:"text-2xl font-bold mb-6 text-center",children:"Login"}),O.jsxs("div",{className:"mb-4",children:[O.jsx("label",{className:"block text-gray-700",children:"Email"}),O.jsx("input",{type:"email",placeholder:"Email",value:e,onChange:d=>n(d.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsxs("div",{className:"mb-6",children:[O.jsx("label",{className:"block text-gray-700",children:"Password"}),O.jsx("input",{type:"password",placeholder:"Password",value:s,onChange:d=>l(d.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsx("button",{type:"submit",className:"w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition duration-300",children:"Login"}),O.jsxs("p",{children:["No account?",O.jsx("a",{onClick:()=>{i("login")},className:"text-blue-200 font-bold cursor-pointer",children:"Log In"})]})]})})};var $p={};const Gp="@firebase/database",Kp="1.0.10";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xo;class Xg extends Al{static get __EMPTY_NODE(){return Xo}static set __EMPTY_NODE(e){Xo=e}compare(e,n){return fi(e.name,n.name)}isDefinedOn(e){throw ai("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return Z.MIN}maxPost(){return new Z(vr,Xo)}makePost(e,n){return D(typeof e=="string","KeyIndex indexValue must always be a string."),new Z(e,Xo)}toString(){return".key"}}const ti=new Xg;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const QC=Math.log(2);class XC{constructor(e){const n=u=>parseInt(Math.log(u)/QC,10),s=u=>parseInt(Array(u+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const l=s(this.count);this.bits_=e+1&l}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const gl=function(i,e,n,s){i.sort(e);const l=function(p,g){const y=g-p;let E,T;if(y===0)return null;if(y===1)return E=i[p],T=n?n(E):E,new We(T,E.node,We.BLACK,null,null);{const L=parseInt(y/2,10)+p,F=l(p,L),B=l(L+1,g);return E=i[L],T=n?n(E):E,new We(T,E.node,We.BLACK,F,B)}},u=function(p){let g=null,y=null,E=i.length;const T=function(F,B){const q=E-F,Pe=E;E-=F;const be=l(q+1,Pe),xe=i[q],Te=n?n(xe):xe;L(new We(Te,xe.node,B,null,be))},L=function(F){g?(g.left=F,g=F):(y=F,g=F)};for(let F=0;F<p.count;++F){const B=p.nextBitIsOne(),q=Math.pow(2,p.count-(F+1));B?T(q,We.BLACK):(T(q,We.BLACK),T(q,We.RED))}return y},d=new XC(i.length),f=u(d);return new ct(s||e,f)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IT{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function TT(i,e){let n=null;for(let s=0;s<e.length;s++){const l=e[s],u=l.getPath();n!==null&&!Yg(u,n.path)&&(i.eventLists_.push(n),n=null),n===null&&(n={events:[],path:u}),n.events.push(l)}n&&i.eventLists_.push(n)}function Jn(i,e,n){TT(i,n),kT(i,s=>Ft(s,e)||Ft(e,s))}function kT(i,e){i.recursionDepth_++;let n=!0;for(let s=0;s<i.eventLists_.length;s++){const l=i.eventLists_[s];if(l){const u=l.path;e(u)?(NT(i.eventLists_[s]),i.eventLists_[s]=null):n=!1}}n&&(i.eventLists_=[]),i.recursionDepth_--}function NT(i){for(let e=0;e<i.events.length;e++){const n=i.events[e];if(n!==null){i.events[e]=null;const s=n.getEventRunner();us&&Qe("event: "+n.toString()),Os(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ik(i){KS(ci),ri(new gr("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),l=e.getProvider("auth-internal"),u=e.getProvider("app-check-internal");return JT(s,l,u,n)},"PUBLIC").setMultipleInstances(!0)),Bn(Gp,Kp,i),Bn(Gp,Kp,"esm2017")}dn.prototype.simpleListen=function(i,e){this.sendRequest("q",{p:i},e)};dn.prototype.echo=function(i,e){this.sendRequest("echo",{d:i},e)};ik();const sk={apiKey:"AIzaSyDol293-uzm6oykcG47e_M4aOj71zG4U9U",authDomain:"node-project-a176d.firebaseapp.com",projectId:"node-project-a176d",storageBucket:"node-project-a176d.firebasestorage.app",messagingSenderId:"705351216802",appId:"1:705351216802:web:d16ccfa16d0f9d1da9b1fb",measurementId:"G-0L9BLHYXST"},ok=kc(sk),lk=nk(ok),ak=async i=>{try{const e=KT(lk,i),n=await qT(e);if(n.exists())return n.val();throw new Error("No data found at the specified route.")}catch(e){throw new Error(`Error fetching data: ${e.message}`)}},uk=()=>{const[i,e]=vt.useState(""),[n,s]=vt.useState(""),[l,u]=vt.useState(""),[d,f]=vt.useState(""),p=async g=>{g.preventDefault();var y=await ak("/events/currentID");console.log(y),await oc("/events/create-event","POST",JSON.stringify({id:y+1,name:i,date:l,location:d,description:n})),await oc("/events/incrementID","POST",JSON.stringify({message:"Increment"}))};return O.jsxs("form",{onSubmit:p,className:"max-w-md mx-auto mt-8 p-6 bg-white shadow-md rounded-lg",children:[O.jsx("h2",{className:"text-2xl font-bold mb-6 text-center",children:"Create Event"}),O.jsxs("div",{className:"mb-4",children:[O.jsx("label",{className:"block text-gray-700",children:"Title"}),O.jsx("input",{type:"text",placeholder:"Title",value:i,onChange:g=>e(g.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsxs("div",{className:"mb-4",children:[O.jsx("label",{className:"block text-gray-700",children:"Description"}),O.jsx("textarea",{placeholder:"Description",value:n,onChange:g=>s(g.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsxs("div",{className:"mb-4",children:[O.jsx("label",{className:"block text-gray-700",children:"Date"}),O.jsx("input",{type:"date",value:l,onChange:g=>u(g.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsxs("div",{className:"mb-4",children:[O.jsx("label",{className:"block text-gray-700",children:"Location"}),O.jsx("input",{type:"text",value:d,onChange:g=>f(g.target.value),className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500",required:!0})]}),O.jsx("button",{type:"submit",className:"w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition duration-300",onClick:()=>{p()},children:"Create Event"})]})},ck=()=>O.jsx("div",{className:"min-h-screen bg-gray-100 p-4",children:O.jsxs("div",{className:"container mx-auto",children:[O.jsx("h1",{className:"text-3xl font-bold text-center mb-8 text-blue-600",children:"Dashboard"}),O.jsx(uk,{})]})}),dk=()=>{const[i,e]=vt.useState("home"),n=()=>{switch(i){case"home":return O.jsx(pp,{setCurrentPage:e});case"register":return O.jsx($S,{setCurrentPage:e});case"login":return O.jsx(GS,{setCurrentPage:e});case"dashboard":return O.jsx(ck,{});default:return O.jsx(pp,{setCurrentPage:e})}};return O.jsxs("div",{children:[O.jsx(By,{setCurrentPage:e}),n()]})};Vy.createRoot(document.getElementById("root")).render(O.jsx(My.StrictMode,{children:O.jsx(dk,{})}));
